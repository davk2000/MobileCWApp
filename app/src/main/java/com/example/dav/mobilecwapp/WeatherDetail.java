...
public class WeatherDetail extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
//this class is used when user selects a listview item within RSS Feed for Glasgow
    ...
    private static final LatLng latlangEKCentre = new LatLng(55.8651, -
            4.2576); //The Latitude and Longitude for Glasgow
 ...
 /* create marker options from the input variables */
    ...
    private void SavedPreference() {
        Intent i = new Intent(WeatherDetail.this, RssInput.class);
        startActivity(i); // called from the actionbar
        //shortcut to the saved preference page
    }

    private void Map() {
        Intent i = new Intent(WeatherDetail.this, mcMapActivity.class);
        startActivity(i); // called from the actionbar
    ...
    private void PieChart() {
        Intent i = new Intent(WeatherDetail.this, PiechartActivity.class);
        startActivity(i); // called from the actionbar
        //shortcut to the Piechart and accelerometer page
    }

    private void LocationDetails() {
        Intent i = new Intent(WeatherDetail.this, DatabaseActivity.class);
        startActivity(i); // called from the actionbar
    ...
    private void showExitDialog() { // called from both the main menu and the action bar
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            { // option 1
                ...
                WeatherDetail.this.finish(); // if option 1 is selected application closing
            }
        });
