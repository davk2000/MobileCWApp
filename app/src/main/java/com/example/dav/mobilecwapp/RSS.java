...
public class RSS extends AppCompatActivity implements OnItemClickListener {
    // This class is used when the option 1 selected within the spinner
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Connection.isNetworkAvailable(this)) {
            new MyRssReadTask() // executes an instance of the subclass in order to utilise AsyncTask
                    .execute("http://open.live.bbc.co.uk/weather/feeds/en/2648579/3dayforecast.rss"); //Glasgow Feed
    ...
    class MyRssReadTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() { //displays dialog which appears before the activity starts for the RSS
            waitingDialog = new ProgressDialog(RSS.this);
    ...
    protected void setDataToListView() { // Method is called onPostExecute
        if (null != arrayList) {
            WeatherAdapter weatherAdapter = new WeatherAdapter(
                    RSS.this, R.layout.rss_row, arrayList);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        Intent intent = new Intent(RSS.this,
                WeatherDetail.class);
    ...
    private void SavedPreference() {
        Intent i = new Intent(RSS.this, RssInput.class);
        startActivity(i); // called from the actionbar
        //shortcut to the saved preference page
    }

    private void Map() {
        Intent i = new Intent(RSS.this, mcMapActivity.class);
        startActivity(i); // called from the actionbar
    ...
    private void PieChart() {
        Intent i = new Intent(RSS.this, PiechartActivity.class);
        startActivity(i); // called from the actionbar
        //shortcut to the Piechart and accelerometer page
    }

    private void LocationDetails() {
        Intent i = new Intent(RSS.this, DatabaseActivity.class);
        startActivity(i); // called from the actionbar
    ...
    private void showExitDialog() { // called from both the main menu and the action bar
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            { // option 1
                ...
                RSS.this.finish(); // if option 1 is selected application closing
            }
        });
