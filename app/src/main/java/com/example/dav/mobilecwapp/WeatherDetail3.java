...
public class WeatherDetail3 extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
//this class is used when user selects a listview item within RSS Feed for Inverness
    ...
    private static final LatLng latlangEKCentre = new LatLng(57.4790, -
            4.2239); //The Latitude and Longitude for Inverness
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mapLocations != null) {
            ...
            mapLocations.getUiSettings().setCompassEnabled(true); //Turns on the Compass
 ...
 /* For all the marker options in dbList list */
        for (int i = 0; i < mapDataLst.size(); i++) {
            ...
            mapDataMarkerList[i] = mapLocations.addMarker(marker); //create a maker and add to the venue markers list
        }
    }
 ...
 /* create marker options from the input variables */
    ...
    private void SavedPreference() {
        Intent i = new Intent(WeatherDetail3.this, RssInput.class);
        startActivity(i); // called from the actionbar
        //shortcut to the saved preference page
    }

    private void Map() {
        Intent i = new Intent(WeatherDetail3.this, mcMapActivity.class);
        startActivity(i); // called from the actionbar
    ...
    private void PieChart() {
        Intent i = new Intent(WeatherDetail3.this, PiechartActivity.class);
        startActivity(i); // called from the actionbar
        //shortcut to the Piechart and accelerometer page
    }

    private void LocationDetails() {
        Intent i = new Intent(WeatherDetail3.this, DatabaseActivity.class);
        startActivity(i); // called from the actionbar
    ...
    private void showExitDialog() { // called from both the main menu and the action bar
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            { // option 1
                ...
                WeatherDetail3.this.finish(); // if option 1 is selected application closing
            }
        });
